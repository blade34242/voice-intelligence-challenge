...
## 12) Video-Skript (2–3 Minuten, wirkt professionell)

* 0:00–0:20 Wer bist du + Ziel der App
* 0:20–1:10 Live-Demo: Hotkey → sprechen → Ergebnis → copy
* 1:10–2:00 Modi zeigen (z. B. Meeting Summary vs Ticket)
* 2:00–2:30 Architektur in 2 Sätzen (Pipeline + warum Tauri/Electron)
* 2:30–3:00 Next Steps + Abschluss

---

Wenn du willst, kann ich dir als Nächstes **konkret** liefern:

* eine **fertige README** (mit Platzhaltern für deinen gewählten Stack/Commands),
* ein **Mode/Prompt-Set** (3–5 Prompts inkl. JSON-Output Schema),
* und eine **Implementations-Checkliste** (Tauri/Electron: Hotkey + Audio + IPC sauber).
